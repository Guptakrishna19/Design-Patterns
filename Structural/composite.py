...
class LeafElement:
    def __init__(self, *args):
        self.position = args[0] # Takes the first positional argument and assigns to member variable "position".
...
if __name__ == "__main__":
    ...
    print("\n After removing Developer11")
    subMenuItem1.remove(subMenuItem11)
    topLevelMenu.showDetails()
